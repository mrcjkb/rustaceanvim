...
## [10.0.0](https://github.com/mrcjkb/rustaceanvim/compare/v9.0.1...v10.0.0) (2026-04-06)
...
* drop ra-multiplex support in favour of lspmux ([#909](https://github.com/mrcjkb/rustaceanvim/issues/909))
...
* `RustLsp relatedTests` command ([#779](https://github.com/mrcjkb/rustaceanvim/issues/779)) ([#942](https://github.com/mrcjkb/rustaceanvim/issues/942)) ([cda05cb](https://github.com/mrcjkb/rustaceanvim/commit/cda05cb2a73dfcc8722504ec9df40c87a49ec029))
...
* drop ra-multiplex support in favour of lspmux ([#909](https://github.com/mrcjkb/rustaceanvim/issues/909)) ([814040e](https://github.com/mrcjkb/rustaceanvim/commit/814040ead173f665353312f68dd9b05c43dcce08))
...
* **cd:** workaround actions/checkout bug (2) ([aa9f96b](https://github.com/mrcjkb/rustaceanvim/commit/aa9f96b7777afd4983095cc6d7a9dcb1f1243edd))
* **ci:** fetch tags so that lux can publish to luarocks ([74cc71f](https://github.com/mrcjkb/rustaceanvim/commit/74cc71f30e70c2f4b788fbc9eb6dae2d1b350235))
...
* **dap:** use non-deprecated `vim.validate` checks ([#998](https://github.com/mrcjkb/rustaceanvim/issues/998)) ([f847f31](https://github.com/mrcjkb/rustaceanvim/commit/f847f31fc0bfbf60a67c2b8c18c1c581cdf336fe))
...
* **lsp:** don't delete `:RustLsp` command on client restart ([#950](https://github.com/mrcjkb/rustaceanvim/issues/950)) ([a5cbc85](https://github.com/mrcjkb/rustaceanvim/commit/a5cbc8565a2030f43069314695bc438d4a42de2c))
...
* **lsp:** force resolution of `vim.lsp.config['*']` for `rust-analyzer` ([#939](https://github.com/mrcjkb/rustaceanvim/issues/939)) ([57b259a](https://github.com/mrcjkb/rustaceanvim/commit/57b259a5707e59e0b2c7cf5b5f86f1fb743ef561))
...
* **lsp:** make `RustLsp` user commands buffer-local ([#953](https://github.com/mrcjkb/rustaceanvim/issues/953)) ([7b19a97](https://github.com/mrcjkb/rustaceanvim/commit/7b19a978df9bed486b38c6af771ccf9475124bc3))
* **lsp:** Merge `vim.lsp.config` settings with `server.default_settings` ([#980](https://github.com/mrcjkb/rustaceanvim/issues/980)) ([e64e384](https://github.com/mrcjkb/rustaceanvim/commit/e64e384f7811f232b7c64c41797d188bd239d944))
* **lsp:** prevent `:RustLsp` command from being created more than once ([f7e7c72](https://github.com/mrcjkb/rustaceanvim/commit/f7e7c720ee37a484642199643ff76705ec10b5ff))
...
## [7.1.3](https://github.com/mrcjkb/rustaceanvim/compare/v7.1.2...v7.1.3) (2026-01-23)
...
## [7.1.2](https://github.com/mrcjkb/rustaceanvim/compare/v7.1.1...v7.1.2) (2026-01-23)
...
## [7.0.9](https://github.com/mrcjkb/rustaceanvim/compare/v7.0.8...v7.0.9) (2026-01-07)
...
## [7.0.0](https://github.com/mrcjkb/rustaceanvim/compare/v6.9.6...v7.0.0) (2025-11-26)
